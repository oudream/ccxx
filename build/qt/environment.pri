#
CCXX_DEPLOY_PATH = $$PWD/../deploy
CCXX_PATH = $$PWD/../..
CCXX_SAMPLE_PATH = $$CCXX_PATH/sample
CCXX_TEST_PATH = $$CCXX_PATH/test
CCXX_TOOLS_PATH = $$CCXX_PATH/tools


INCLUDEPATH += $$CCXX_PATH
INCLUDEPATH += $$CCXX_PATH/include
...
win32 {
    CCXX_BIN_PATH = $$CCXX_DEPLOY_PATH/win32/$$PROJECT_DEPLOY_NAME
}
unix {
    CCXX_BIN_PATH = $$CCXX_DEPLOY_PATH/unix/$$PROJECT_DEPLOY_NAME
}
x11 {
    CCXX_BIN_PATH = $$CCXX_DEPLOY_PATH/x11/$$PROJECT_DEPLOY_NAME
}


#### project destdir ###
isEmpty( PROJECT_BIN_PATH ) {
    PROJECT_BIN_PATH = $$CCXX_BIN_PATH
}
