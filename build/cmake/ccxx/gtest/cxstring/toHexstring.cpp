...
// Tests the Increment() method.
    ...
    {
        EXPECT_EQ(CxString::toHexstring(0), "0x00000000");
        EXPECT_EQ(CxString::toHexstring(1), "0x00000001");
        EXPECT_EQ(CxString::toHexstring(9), "0x00000009");
        EXPECT_EQ(CxString::toHexstring(10), "0x0000000A");
        EXPECT_EQ(CxString::toHexstring(11), "0x0000000B");
        EXPECT_EQ(CxString::toHexstring(13), "0x0000000D");
    }
