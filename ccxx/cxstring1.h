...
public:
    ...
    static void fromString(const std::string& sSource, bool& b);

    static void fromString(const std::string& sSource, int& i);

    static void fromString(const std::string& sSource, uint32& n);

    static void fromString(const std::string& sSource, int64& n);

    static void fromString(const std::string& sSource, uint64& n);

    static void fromString(const std::string& sSource, double& d);

    static void fromString(const std::string& sSource, float& f);

    static void fromString(const std::string& sSource, std::string& s);
    ...
    static std::vector<std::string> split(const std::string& s, char cSplitCharacter = CxGlobal::lineCharacter, bool bHasEmptyString = false);

    static std::vector<std::string> split(const std::string& s, const std::string& sSplitString, bool bHasEmptyString = false);
    ...
    static std::vector<std::string> splitCase(const std::string& s, const std::string& sSplitString, bool bHasEmptyString = false);

    static std::map<std::string, std::string> splitToMap(const std::string& s, char cMid, char cSplitCharacter, bool bTrim = true);

    static std::map<std::string, std::string> splitToMap_reverse(const std::string& s, char cMid, char cSplitCharacter, bool bTrim = true);

    static std::vector<std::vector<std::string> > splitToLines(const std::string& s, char cMid, char cSplitCharacter);

    static std::vector<std::map<std::string, std::string> > splitToLines(const std::vector<std::string>& sRows, char cMid, char cSplitCharacter);
...
//    static uint32 toUint32(uchar *pBuff,int iLenth,bool bInverse = true);
    ...
    static inline std::string newString(const std::string & s) { return std::string(s.data(), s.size()); }
