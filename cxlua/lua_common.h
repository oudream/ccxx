...
{
public:
    static inline CxOutStream outScriptPrompt() {
        CxOutStream r; r.noend(); r.type(CxInterinfo::Type_Script); r << CxGlobal::promptString << " Script : "; return r;
    }

#if defined(GM_DEBUG)
    static inline CxOutStream outScriptDebug() {
        CxOutStream r; r.noend(); r.type(CxInterinfo::Type_Script); r << CxGlobal::debugString << " Script : "; return r;
    }
#else
#undef outScriptDebug
    static inline CxNoOutStream outScriptDebug() { return CxNoOutStream(); }
