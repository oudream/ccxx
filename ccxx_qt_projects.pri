...
INCLUDEPATH += $$CCXX_PATH/ccxx/regexp
...
unix {
    CONFIG(debug, debug|release) : PROJECT_BIN_PATH = /usr/deploy/ccxx_debug
    CONFIG(release, debug|release) : PROJECT_BIN_PATH = /usr/deploy/ccxx_release
