...
cmake . -DCMAKE_BUILD_TYPE=Debug --build "/opt/ddd/ccpp/ccxx" -B"/opt/ddd/ccpp/ccxx/cmake-gcc"
cd cmake-gcc && make
export GTEST_OUTPUT="xml:/opt/ddd/ccpp/ccxx/cmake-gcc/unittest-report"
make test
